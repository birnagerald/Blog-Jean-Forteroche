...
<hr>
<p style="text-align: center">Il y a actuellement <?=$nbrComments?> commentaires. En voici la liste :</p>

<table class="minimalistBlack">
  <thead class="minimalistBlack">
    <tr class="minimalistBlack"><th>Auteur</th><th>Titre</th><th>Contenu</th><th>Action</th></tr>
  </thead>
<?php
